...
The binding coding conventions live in [`CLAUDE.md`](CLAUDE.md) (the single
source of truth) and its referenced global style guide. Match the surrounding
code; the documented rules take precedence over rustfmt/clippy where they differ.
...
- **Public API is a contract.** `ratada` is a published library; changes to a
